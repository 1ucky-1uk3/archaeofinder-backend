...
def parse_europeana_result(item: dict) -> MuseumObject:
    ...
    if "guid" in item:
        ...
        source_url = f"[https://www.europeana.eu/item](https://www.europeana.eu/item){item['id']}"
        ...
        "sources": [
            {
                ...
                "status": "active",
                "website": "[https://www.europeana.eu](https://www.europeana.eu)"
            },
            {
                "id": "ddb",
                ...
                "status": "coming_soon",
                "website": "[https://www.deutsche-digitale-bibliothek.de](https://www.deutsche-digitale-bibliothek.de)"
            },
            {
                "id": "british_museum",
                "name": "British Museum",
